...
verification_user_id=superr_objj.verification_user_id;
...
//alert('co_final_command if inside');
if( final !== null){
for(a=0;a<coordinator_final_comment_array.length;a++){
 ...
 //alert(coordinator_final_commanda+'co_final_command');
}
}
}

var finaltec = tvo_extra_comment_array;
//alert(tvo_extra_comment_array+'tvo_extra_comment_array');
if( finaltec !== null){
 // alert('fianl tec');
...
if(qualification_id == '102' ){
    ...
    if(verification_maste !== undefined){
            if(supervisor_final_commanda !== undefined){
           if(tvo_extra_commenta !== undefined){
            //alert('tvo_extra_commenta    sssssuccccccessss')
sessionStorage.setItem("tvo_extra_commenta",JSON.stringify(tvo_extra_commenta));
         }
         if(coordinator_final_commanda !== undefined){
//alert("coordinator_final_commanda sessionStorage");
