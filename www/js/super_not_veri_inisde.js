...
//alert(oneemp);
  $('.sddqinot').append('<li><a href="http://staging.eimpressive.com/insurance-changes/uploads/'+oneemp+'"><img src="http://staging.eimpressive.com/insurance-changes/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
var oneemp=employimg_obj.document;
// /alert(oneemp);
  $('.ssd').append('<li><a href="http://staging.eimpressive.com/insurance-changes/uploads/'+oneemp+'"><img src="http://staging.eimpressive.com/insurance-changes/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
//alert(one+'oneoooooooooooooooooooooooooo');
     $('.s1').append('<li><a href="http://staging.eimpressive.com/insurance-changes/uploads/'+one+'"><img src="http://staging.eimpressive.com/insurance-changes/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//alert(oneo+'two');
   $('.s1').append('<li><a href="http://staging.eimpressive.com/insurance-changes/uploads/'+oneo+'"><img src="http://staging.eimpressive.com/insurance-changes/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//$('.document_imag_inproone_notveria').append('<img src="http://staging.eimpressive.com/uploads/'+oneoo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
   $('.s1').append('<li><a href="http://staging.eimpressive.com/insurance-changes/uploads/'+oneoo+'"><img src="http://staging.eimpressive.com/insurance-changes/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//$('.document_imag_inproone_notverid').append('<img src="http://staging.eimpressive.com/uploads/'+oneooo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
   $('.s1').append('<li><a href="http://staging.eimpressive.com/insurance-changes/uploads/'+oneooo+'"><img src="http://staging.eimpressive.com/insurance-changes/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//$('.document_imag_inproone_notverie').append('<img src="http://staging.eimpressive.com/uploads/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
   $('.s1').append('<li><a href="http://staging.eimpressive.com/insurance-changes/uploads/'+oner+'"><img src="http://staging.eimpressive.com/insurance-changes/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');
