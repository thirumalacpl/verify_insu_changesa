...
$('#fir_finalcommand_comp').show();
$('#driver_finalcommand_comp').hide();
$('#claimant_finalcommand_comp').hide();
 $('#accid_finalcommand_comp').hide();
   $('#owner_finalcommand_comp').hide();
}
if(qualification_id == '99'){
  //alert('99 final_comment');
$('#driver_finalcommand_comp').show();
$('#fir_finalcommand_comp').hide();
$('#claimant_finalcommand_comp').hide();
 $('#accid_finalcommand_comp').hide();
   $('#owner_finalcommand_comp').hide();
}
...
$('#claimant_finalcommand_comp').show();
$('#fir_finalcommand_comp').hide();
$('#driver_finalcommand_comp').hide();
 $('#accid_finalcommand_comp').hide();
   $('#owner_finalcommand_comp').hide();
...
// /alert(oneemp);
  $('.s22').append('<li><a href="http://staging.eimpressive.com/insurance-changes/uploads/'+oneemp+'"><img src="http://staging.eimpressive.com/insurance-changes/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
//alert(oneemp+'oneemp image');
  $('.s22').append('<li><a href="http://localhost/insurance-changes/uploads/'+oneemp+'"><img src="http://localhost/insurance-changes/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
