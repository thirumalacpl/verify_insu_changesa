...
var img_first_name = 'thirumal m 12313423154';
var imz_in_div_inputa_owner='<li class="li_hei"> <div class="li_pri_left"></div><img src="images/primary/city.png" alt="" class="li_img_pri"> <p class="li_p_pri"><span class="fonn">Name :</span><span class="fonnt"><input value="'+driver_details_o.name+'"  id="owner_name"></span></p></li><li class="li_hei"> <div class="li_pri_left"></div><img src="images/primary/city.png" alt="" class="li_img_pri"> <p class="li_p_pri"><span class="fonn">Address :</span><span class="fonnt"><input value="'+driver_details_o.address+'"  id="owner_adress"></span></p></li><li class="li_hei">  <div class="li_pri_left"></div><img src="images/primary/city.png" alt="" class="li_img_pri"> <p class="li_p_pri"><span class="fonn">Contact No:</span><span class="fonnt"><input value="'+driver_details_o.con_no+'"  id="owner_con_no"></span></p></li><li class="li_hei">  <div class="li_pri_left"></div><img src="images/primary/city.png" alt="" class="li_img_pri"> <p class="li_p_pri"><span class="fonn">Select Gender :</span><span class="fonnt"><input value="'+driver_details_o.gender+'"  id="owner_gender"></span></p></li><li class="li_hei">  <div class="li_pri_left"></div><img src="images/primary/city.png" alt="" class="li_img_pri"> <p class="li_p_pri"><span class="fonn">Type of DL :</span><span class="fonnt"><input value="'+driver_details_o.dl_type+'"  id="owner_dl_type"></span></p></li><li class="li_hei">  <div class="li_pri_left"></div><img src="images/primary/city.png" alt="" class="li_img_pri"> <p class="li_p_pri"><span class="fonn">DOB :</span><span class="fonnt"><input value="'+driver_details_o.dob+'"  id="owner_dob">'+driver_details_o.dob+'</span></p></li><li class="li_hei">  <div class="li_pri_left"></div><img src="images/primary/city.png" alt="" class="li_img_pri"> <p class="li_p_pri"><span class="fonn">Driving Licence No :</span><span class="fonnt"><input value="'+driver_details_o.dl_no+'"  id="owner_dl_no"></span></p></li><li class="li_hei">  <div class="li_pri_left"></div><img src="images/primary/city.png" alt="" class="li_img_pri"> <p class="li_p_pri"><span class="fonn">Issuing Authority :</span><span class="fonnt"><input value="'+driver_details_o.issue_autho+'"  id="owner_issue_autho">'+driver_details_o.issue_autho+'</span></p></li><li class="li_hei">  <div class="li_pri_left"></div><img src="images/primary/city.png" alt="" class="li_img_pri"> <p class="li_p_pri"><span class="fonn">Date of issue & Expiry :</span><span class="fonnt"><input value="'+driver_details_o.doi_exp+'"  id="owner_doi_exp"></span></p></li><li class="li_hei">  <div class="li_pri_left"></div><img src="images/primary/city.png" alt="" class="li_img_pri"> <p class="li_p_pri"><span class="fonn">Vehicles authorized to drive :</span><span class="fonnt"><input value="'+driver_details_o.vec_auth+'"  id="owner_vec_auth"></span></p></li><li class="li_hei">  <div class="li_pri_left"></div><img src="images/primary/city.png" alt="" class="li_img_pri"> <p class="li_p_pri"><span class="fonn">Badge No :</span><span class="fonnt"><input value="'+driver_details_o.bdg_no+'"  id="owner_bdg_no"></span></p></li><li class="li_hei">  <div class="li_pri_left"></div><img src="images/primary/city.png" alt="" class="li_img_pri"> <p class="li_p_pri"><span class="fonn">Date if Applicable :</span><span class="fonnt"><input value="'+driver_details_o.date_app+'"  id="owner_date_app"></span></p></li><li class="li_hei">  <div class="li_pri_left"></div><img src="images/primary/city.png" alt="" class="li_img_pri"> <p class="li_p_pri"><span class="fonn">Provide opposite Vehicles driver details :</span><span class="fonnt"><input value="'+driver_details_o.opp_dr_dtls+'"  id="owner_opp_dr_dtls"></span></p></li><li class="li_hei">  <div class="li_pri_left"></div><img src="images/primary/city.png" alt="" class="li_img_pri"> <p class="li_p_pri"><span class="fonn">Age:</span><span class="fonnt"><input value="'+driver_details_o.age+'"  id="owner_age"></span></p></li><li class="li_hei">  <div class="li_pri_left"></div><img src="images/primary/city.png" alt="" class="li_img_pri"> <p class="li_p_pri"><span class="fonn">DL Place of Issue:</span><span class="fonnt"><input value="'+driver_details_o.dl_place_issue+'"  id="o_dl_place_issue"></span></p></li><li class="li_hei">  <div class="li_pri_left"></div><img src="images/primary/city.png" alt="" class="li_img_pri"> <p class="li_p_pri"><span class="fonn">Driver Education:</span><span class="fonnt"><input value="'+driver_details_o.driver_education+'"  id="o_driver_education"></span></p></li><li class="li_hei">  <div class="li_pri_left"></div><img src="images/primary/city.png" alt="" class="li_img_pri"> <p class="li_p_pri"><span class="fonn">Driver Experience:</span><span class="fonnt"><input value="'+driver_details_o.driver_exp+'"  id="o_driver_exp"></span></p></li><li class="li_hei">  <div class="li_pri_left"></div><img src="images/primary/city.png" alt="" class="li_img_pri"> <p class="li_p_pri"><span class="fonn">DL Valid For:</span><span class="fonnt"><input value="'+driver_details_o.dl_valid_for+'"  id="o_dl_valid_for"></span></p></li><li class="li_hei">  <div class="li_pri_left"></div><img src="images/primary/city.png" alt="" class="li_img_pri"> <p class="li_p_pri"><span class="fonn">Class of DL:</span><span class="fonnt"><input value="'+driver_details_o.class_of_dl+'"  id="o_class_of_dl">'+driver_details_o.class_of_dl+'</span></p></li><li class="li_hei">  <div class="li_pri_left"></div><img src="images/primary/city.png" alt="" class="li_img_pri"> <p class="li_p_pri"><span class="fonn">Driver from the same locality:</span><span class="fonnt"><input value="'+driver_details_o.driver_same_locality+'"  id="o_driver_same_locality"></span></p></li><li class="li_hei">  <div class="li_pri_left"></div><img src="images/primary/city.png" alt="" class="li_img_pri"> <p class="li_p_pri"><span class="fonn">Driver in petition is same as fir:</span><span class="fonnt"><input value="'+driver_details_o.driver_petition_same_fir+'"  id="o_driver_petition_same_fir"></span></p></li><li class="li_hei">  <div class="li_pri_left"></div><img src="images/primary/city.png" alt="" class="li_img_pri"> <p class="li_p_pri"><span class="fonn">Criminal Case status against driver:</span><span class="fonnt"><input value="'+driver_details_o.criminal_case_status+'"  id="ocriminal_case_status"></span></p></li><li class="li_hei">  <div class="li_pri_left"></div><img src="images/primary/city.png" alt="" class="li_img_pri"> <p class="li_p_pri"><span class="fonn">Date of Issue :</span><span class="fonnt"><input value="'+driver_details_o.do_issue+'"  id="o_do_issue"></span></p></li><li class="li_hei">  <div class="li_pri_left"></div><img src="images/primary/city.png" alt="" class="li_img_pri"> <p class="li_p_pri"><span class="fonn">Driver involved in any accident in last 2 years:</span><span class="fonnt"><input value="'+driver_details_o.dr_invloved+'"  id="o_dr_invloved"></span></p></li><li class="li_hei">  <div class="li_pri_left"></div><img src="images/primary/city.png" alt="" class="li_img_pri"> <p class="li_p_pri"><span class="fonn">Is the driver under any influence of intoxicating liquor or drugs:</span><span class="fonnt"><input value="'+driver_details_o.dr_influ+'"  id="o_dr_influ"></span></p></li><li class="li_hei">  <div class="li_pri_left"></div><img src="images/primary/city.png" alt="" class="li_img_pri"> <p class="li_p_pri"><span class="fonn">Any other relevant information:</span><span class="fonnt"><input value="'+driver_details_o.othr_info+'"  id="o_othr_info"></span></p></li>'
...
var img_first_name = 'thirumal m 12313423154';
var imz_in_div_inputa_claiman_injured_decea='<li class="li_hei">  <div class="li_pri_left"></div><img src="images/primary/city.png" alt="" class="li_img_pri"><p class="li_p_pri">Name:<input value="'+details_decea.name+'"  id="dece_name"></p></li><li class="li_hei">  <div class="li_pri_left"></div><img src="images/primary/city.png" alt="" class="li_img_pri"><p class="li_p_pri">Address:<input value="'+details_decea.address+'"  id="dece_address"></p></li><li class="li_hei">  <div class="li_pri_left"></div> <img src="images/primary/city.png" alt="" class="li_img_pri"><p class="li_p_pri">Contact No:<input value="'+details_decea.contact+'"  id="dece_contact"></p></li><li class="li_hei">  <div class="li_pri_left"></div> <img src="images/primary/city.png" alt="" class="li_img_pri"><p class="li_p_pri">Age:<input value="'+details_decea.age+'"  id="dece_age"></p></li><li class="li_hei">  <div class="li_pri_left"></div> <img src="images/primary/city.png" alt="" class="li_img_pri"><p class="li_p_pri">Gender:<input value="'+details_decea.gender+'"  id="dece_gender"></p></li><li class="li_hei">  <div class="li_pri_left"></div> <img src="images/primary/city.png" alt="" class="li_img_pri"><p class="li_p_pri">Marital Status:<input value="'+details_decea.marital_status+'"  id="dece_marital_status"></p></li><li class="li_hei">  <div class="li_pri_left"></div> <img src="images/primary/city.png" alt="" class="li_img_pri"><p class="li_p_pri">Is the Deceased:<input value="'+details_decea.isdeceased+'"  id="dece_isdeceased"></p></li><li class="li_hei">  <div class="li_pri_left"></div> <img src="images/primary/city.png" alt="" class="li_img_pri"><p class="li_p_pri">Relationship with the claimant:<input value="'+details_decea.relationship+'"  id="dece_relationship"></p></li><li class="li_hei">  <div class="li_pri_left"></div> <img src="images/primary/city.png" alt="" class="li_img_pri"><p class="li_p_pri">Details of injury suffered:<input value="'+details_decea.injured_details+'"  id="dece_injured_details"></p></li><li class="li_hei">  <div class="li_pri_left"></div> <img src="images/primary/city.png" alt="" class="li_img_pri"><p class="li_p_pri">Occupation:<input value="'+details_decea.occupation+'"  id="dece_occupation"></p></li><li class="li_hei">  <div class="li_pri_left"></div> <img src="images/primary/city.png" alt="" class="li_img_pri"><p class="li_p_pri">Annual Income:<input value="'+details_decea.annual_income+'"  id="dece_annual_income"></p></li><li class="li_hei">  <div class="li_pri_left"></div> <img src="images/primary/city.png" alt="" class="li_img_pri"><p class="li_p_pri">Is Personal Accident Benefit:<input value="'+details_decea.accident_benefit+'"  id="dece_accident_benefit"><p></li><li class="li_hei">  <div class="li_pri_left"></div> <img src="images/primary/city.png" alt="" class="li_img_pri"><p class="li_p_pri">Details of Asset owned:<input value="'+details_decea.asset_owned+'"  id="dece_asset_owned"></p></li><li class="li_hei">  <div class="li_pri_left"></div> <img src="images/primary/city.png" alt="" class="li_img_pri"><p class="li_p_pri">Name of Employer:<input value="'+details_decea.emp_name+'"  id="dece_emp_name"></p></li><li class="li_hei">  <div class="li_pri_left"></div> <img src="images/primary/city.png" alt="" class="li_img_pri"><p class="li_p_pri">Address of Employer:<input value="'+details_decea.emp_address+'"  id="dece_emp_address"></p></li><li class="li_hei">  <div class="li_pri_left"></div> <img src="images/primary/city.png" alt="" class="li_img_pri"><p class="li_p_pri">Employer Contact:<input value="'+details_decea.emp_contact+'"  id="dece_emp_contact"></p></li><li class="li_hei">  <div class="li_pri_left"></div> <img src="images/primary/city.png" alt="" class="li_img_pri"><p class="li_p_pri">Brief Statement of Employer:<input value="'+details_decea.emp_statement+'"  id="dece_emp_statement"></p></li><li class="li_hei">  <div class="li_pri_left"></div><img src="images/primary/city.png" alt="" class="li_img_pri"><p class="li_p_pri">Date of Death:<input value="'+details_decea.dofd+'"  id="dece_dofd"></p></li><li class="li_hei">  <div class="li_pri_left"></div><img src="images/primary/city.png" alt="" class="li_img_pri"><p class="li_p_pri">Date of PM:<input value="'+details_decea.dofpm+'"  id="dece_dofpm"></p></li><li class="li_hei">  <div class="li_pri_left"></div> <img src="images/primary/city.png" alt="" class="li_img_pri"><p class="li_p_pri">Date of Panchanama:<input value="'+details_decea.dofpnama+'"  id="dece_dofpnama"></p></li><li class="li_hei">  <div class="li_pri_left"></div> <img src="images/primary/city.png" alt="" class="li_img_pri"><p class="li_p_pri">PM Copy Provided:<input value="'+details_decea.pmcopy+'"  id="dece_pmcopy"></p></li><li class="li_hei">  <div class="li_pri_left"></div> <img src="images/primary/city.png" alt="" class="li_img_pri"><p class="li_p_pri">Cause of death as per PMR:<input value="'+details_decea.cause_pmr+'"  id="dece_cause_pmr"></p></li><li class="li_hei">  <div class="li_pri_left"></div> <img src="images/primary/city.png" alt="" class="li_img_pri"><p class="li_p_pri">Police Details on death:<input value="'+details_decea.police_details+'"  id="dece_police_details"></p></li>'
